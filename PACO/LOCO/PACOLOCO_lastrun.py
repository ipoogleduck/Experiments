...
expName = 'PACOLOCO'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Volumes/bamlab/Experiments/PACO/LOCO/PACOLOCO_lastrun.py',
...
#number of OLD + NEW items they'll be tested on
num_test = 75 #75
...
DragText2 = visual.TextStim(win=win, name='DragText',
    text='Next, Drag and Drop the object to a location on the screen',
    font='Arial',
    pos=(0, -0.4), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
while continueRoutine:
    ...
    elif not hasDragged and not isOnColor:
        helpDrag = True #Tells the user to drag if they have already colored
    elif not isOnColor and not isDragging: #Tells user they can continue once they've colored and placed, re-uses colortext2 text
