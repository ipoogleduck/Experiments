...
OldOrNew rt and Test rt are reaction times of the user (Note that the oldornew rt is always above one second as the user is required to wait one second before responding).
