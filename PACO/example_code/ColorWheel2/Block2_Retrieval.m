...
root = pwd;
fName = [root, '\Subject Data\', num2str(subNum),'_Block_2_', 'LTM_Encoding.mat'];
load(fName)
...
fName = [p.root, '\Subject Data\', num2str(p.subNum),'_Block_2_','LTM_Retrieval_1.mat'];
