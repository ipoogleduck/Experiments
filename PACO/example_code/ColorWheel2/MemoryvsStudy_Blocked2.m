...
function MemoryvsStudy_Blocked2
...
fName = [root,'/ImageNames2.mat'];
load(fName);
%nStims = length(imgNames);
stim.ImageNames = ImageNames2;
...
fName = [p.root, '\Subject Data\', num2str(p.subNum),'_Block_2_','LTM_Encoding.mat'];
